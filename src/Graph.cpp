...
/*!
 * procura os aeroportos mais proximos das coordenadas dadas
 * @param lat1
 * @param long1
 * @param lat2
 * @param long2
...
/*!
 * escolhe o destino mais proximo em termos do numero de voos necessario
 * @param src
 * @param chegada
 * @return de um para com o indice do aeroporto e o numero de voos
 */
...
/*!
 * dependendo dos inputs, e associado um tipo e dependendo desse tipo escolhe o aeroporto
